# Written by Mitchell Wiebe - July 19th, 2021 [edited Sept 23rd, 2021]
...
# to run in command prompt: ''' python C:\Users\wiebe007\my_scripts\sort_to_target_subset.py '''
...
new_dir = r'C:\Users\wiebe007\DeepPATH-master-Copy\TESTING\TEST_ALL\2.5x\299px\Subset_testing'
...
# - for any slide that is used, all tiles are used?
